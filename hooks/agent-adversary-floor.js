...
// including this guard's own documented fail-open behavior.
let decisions;
try {
...
if (require.main === module) {
  ...
  try {
    ...
    // own exit code (0, unchanged — this guard's documented fail-open
    // behavior) is decided independently below, never by whether this
    // call throws.
    try {
